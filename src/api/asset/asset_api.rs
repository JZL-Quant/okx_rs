...
use crate::dto::asset_model::{AssetBalance, DepositRecord, TransferRecord, WithdrawalRecord};
...
impl OkxAsset {
    ...
    /// 获取资产余额
    pub async fn get_balances(&self, ccy: Option<&str>) -> Result<Vec<AssetBalance>, Error> {
