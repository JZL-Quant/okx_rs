...
use crate::dto::market_model::{Candle, Depth, Instrument, Ticker};
...
impl OkxMarket {
    ...
    pub async fn get_ticker(&self, inst_id: &str) -> Result<Ticker, Error> {
        ...
        let tickers = self
            .client
            .send_request::<Vec<Ticker>>(Method::GET, &path, "")
            .await?;
    ...
    pub async fn get_candles(
        ...
        self.client
            .send_request::<Vec<Candle>>(Method::GET, &path, "")
            .await
    }
    ...
    pub async fn get_instruments(
        ...
        self.client
            .send_request::<Vec<Instrument>>(Method::GET, &path, "")
            .await
    }
}
...
mod tests {
    ...
    async fn test_get_candles() {
        let market = OkxMarket::from_env().expect("无法从环境变量创建市场API");
        let candles = market
            .get_candles("BTC-USDT", Some("1D"), None, None, Some(10))
            .await;
