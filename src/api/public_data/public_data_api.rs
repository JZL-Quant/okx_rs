...
use crate::dto::public_data::public_data::{EconomicEvent, RateLimit, SystemStatus, SystemTime};
...
impl OkxPublicData {
    ...
    pub async fn get_instruments(
        ...
        self.client
            .send_request::<Vec<InstrumentInfo>>(Method::GET, &path, "")
            .await
    }
    ...
    pub async fn get_economic_calendar(
        ...
        self.client
            .send_request::<Vec<EconomicEvent>>(Method::GET, &path, "")
            .await
    }
